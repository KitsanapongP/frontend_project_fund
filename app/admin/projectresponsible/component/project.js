...
import { GetDataprojectUserByYear } from "../../../fetch_api/fetch_api_admin"; // ปรับ path ตามจริง
          ...
          <div style={{ padding: "5px" }}>
            <button
              ...
              onClick={() => {
                ...
                // เปลี่ยนหน้า
                window.location.href = `/admin/projectresponsible/project/${row.project.project_number}`;
              }}
            >
