...
import DatatablePrinciple from "../../componentTable/principle";
import { ModalAddPrinciple } from "../modal/modal_principle";
      ...
      <div className="">
        ...
        <div className="grid grid-cols-12  gap-0 w-full min-h-screen mt-20">
          ...
          <div className="col-span-12 xl:col-span-10  md:col-span-9 mt-5 ms-4 md:mt-3 me-4 md:me-6">
            ...
            <div>
              <DatatablePrinciple onEdit={toggleModalEdit} />
              {/* <DatatableProject /> */}
            </div>
          </div>
        </div>
