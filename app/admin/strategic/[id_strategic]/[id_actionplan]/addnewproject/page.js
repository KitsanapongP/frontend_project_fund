...
import {
  ...
  ModalAddUserNew,
} from "../addnewproject/component/modal";
...
export default function addProject({}) {
          ...
          <div style={{ padding: "5px" }}>
            ...
            <button
              ...
              onClick={() =>
                setdataAddNewProject((prev) => ({
                  ...prev,
                  okr: prev.okr.filter((item) => item.id !== row.id),
                }))
  ...
  return (
    <>
              ...
              <div className="grid grid-cols-12 gap-x-8 gap-y-6 mt-3">
                ...
                <div className="col-span-12 md:col-span-6">
                  ...
                  <input
                    ...
                    value={
                      dataAddNewProject.price
                        ? Number(dataAddNewProject.price).toLocaleString(
                            "th-TH"
                          )
                        : ""
                    }
                    ...
                    >
                      <div className="relative">
                        ...
                        <input
                          ...
                          value={dataAddNewProject.start_date}
                          onChange={(e) =>
                            setdataAddNewProject((prev) => ({
                              ...prev,
                      ...
                      <div className="relative">
                        ...
                        <input
                          ...
                          name="end"
                          type="date"
                          disabled={!dataAddNewProject.start_date}
                          className={`xl:w-67 md:w-39 w-39 ${
                            !dataAddNewProject.start_date
                              ? "bg-gray-100"
                              : "bg-white"
                          ...
                          value={dataAddNewProject.end_date}
                          min={dataAddNewProject.start_date || ""}
                          onChange={(e) =>
                            setdataAddNewProject((prev) => ({
                              ...prev,
                      ...
                      return (
                        ...
                        >
                          <input
                            ...
                            type="checkbox"
                            value={item.value}
                            checked={dataAddNewProject.type.includes(
                              item.value
                            )}
                            ...
                            onChange={() =>
                              setdataAddNewProject((prev) => ({
                                ...
                                type: prev.type.includes(item.value)
                                  ? prev.type.filter((v) => v !== item.value)
                      ...
                      return (
                        ...
                        >
                          <input
                            ...
                            type="checkbox"
                            value={item.value}
                            checked={dataAddNewProject.principles.includes(
                              item.value
                            )}
                            className="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded-sm focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600"
                            onChange={() =>
                              setdataAddNewProject((prev) => ({
                                ...prev,
                                principles: prev.principles.includes(item.value)
                                  ? prev.principles.filter(
                                      (v) => v !== item.value
                                    )
                                  : [...prev.principles, item.value],
                              }))
                            }
                          />
                          <label
                ...
                <div className="col-span-12 ">
                  ...
                  /> */}
                  <CustomEditor
                    value={dataAddNewProject.reason}
                    onChange={(value) =>
                      setdataAddNewProject({
                        ...dataAddNewProject,
                        reason: value, // value คือค่าจาก editor.getData()
                      })
                    }
                  />
                </div>
      ...
      {strategic && isOpenModalObjectiveAdd && (
        <ModalAddObjectiveNew
      ...
      {strategic && isOpenModalUserAdd && typeUser == 1 && (
        <ModalAddUserNew
      ...
      {strategic && isOpenModalUserAdd && typeUser == 2 && (
        <ModalAddUserNew
          onClose={() => setIsOpenModalUserAdd(false)}
          isOpen={ModalAddUserNew}
          type={typeUser}
