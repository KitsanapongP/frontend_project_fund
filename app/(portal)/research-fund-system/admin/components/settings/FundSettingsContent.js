...
import YearManagementTab from "@/app/(portal)/research-fund-system/admin/components/settings/years_config/YearManagementTab";
import FundManagementTab from "@/app/(portal)/research-fund-system/admin/components/settings/funds_config/FundManagementTab";
import RewardConfigManager from "@/app/(portal)/research-fund-system/admin/components/settings/reward_config/RewardConfigManager";
import EndOfContractManager from "@/app/(portal)/research-fund-system/admin/components/settings/end_of_contract_config/EndOfContractManager";
import SystemConfigSettings from "@/app/(portal)/research-fund-system/admin/components/settings/system_config/SystemConfigSettings";
import AnnouncementManager from "@/app/(portal)/research-fund-system/admin/components/settings/announcement_config/AnnouncementManager";
import DocumentTypeManager from "@/app/(portal)/research-fund-system/admin/components/settings/document_config/DocumentTypeManager";
import InstallmentManagementTab from "@/app/(portal)/research-fund-system/admin/components/settings/installment_config/InstallmentManagementTab";
...
import SubcategoryModal from "@/app/(portal)/research-fund-system/admin/components/settings/funds_config/SubcategoryModal";
import BudgetModal from "@/app/(portal)/research-fund-system/admin/components/settings/funds_config/BudgetModal";
import DeleteConfirmDialog from "@/app/(portal)/research-fund-system/admin/components/settings/funds_config/DeleteConfirmDialog";
