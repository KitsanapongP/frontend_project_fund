...
export default function ComparisonTable({ periodLabel, isRange = false, row, insights, scopeConsistent = true }) {
  const heading = `เปรียบเทียบ${isRange ? "ช่วงปี" : "ปี"} ${periodLabel}`;
  ...
  return (
    <section className="border-b border-slate-200 py-6" aria-label={`ตารางเปรียบเทียบ ${periodLabel}`}>
      ...
      <div className="overflow-x-auto">
        ...
        <table className="w-full min-w-[680px] border-collapse text-sm">
          <caption className="sr-only">เปรียบเทียบตัวชี้วัดของคณะ มหาวิทยาลัยขอนแก่น และประเทศไทย สำหรับ {periodLabel}</caption>
          <thead>
          ...
          <tbody>
            ...
            <tr>
              <th scope="row" className="border-b border-slate-200 px-3 py-3.5 text-left font-normal text-slate-700">
                <span className="inline-flex items-center gap-1">ผลงานในวารสารกลุ่ม T1–Q2 <Hint text={HINT_T1Q2} label="ผลงานในวารสารกลุ่ม T1–Q2" /></span>
              </th>
            ...
            <tr>
              <th scope="row" className="border-b border-slate-200 px-3 py-3.5 text-left font-normal text-slate-700">
                <span className="inline-flex items-center gap-1">ผลงานร่วมกับต่างประเทศ <span className="text-[11px] font-normal text-slate-400">(observed)</span> <Hint text={HINT_INTL} label="ผลงานร่วมกับต่างประเทศ" /></span>
              </th>
