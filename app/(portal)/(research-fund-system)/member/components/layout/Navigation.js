...
export default function Navigation({
  ...
  const adminShortcutItems = [
    ...
    },
    {
      ...
      label: "ค้นหางานวิจัย",
      icon: Search,
      route: "/admin/scopus-research-search",
