...
import { GetDataactionplanUserByidproject } from "../../../fetch_api/fetch_api_superadmin"; // ปรับ path ตามจริง
...
export default function DatatableActivity({
  ...
  const fetchData = useCallback(async (page = 1, perPage = 10) => {
    try {
      ...
      const res = await GetDataactionplanUserByidproject(
        token,
        id_projectref,
        page,
        perPage
          ...
          <div style={{ padding: "5px" }}>
            <button
              ...
              onClick={() => {
                ...
                // เปลี่ยนหน้า
                window.location.href = `/superadmin/project/${id_project}/${row.id}`;
              }}
            >
          ...
          <div style={{ padding: "5px" }}>
            <button
              ...
              onClick={() => {
                ...
                // เปลี่ยนหน้า
                window.location.href = `/superadmin/project/${row.strategic_number}`;
              }}
            >
