...
import DatatableType from "../../componentTable/type";
import { ModalAddType } from "../modal/modal_type";
          ...
          <div className="col-span-12 xl:col-span-10  md:col-span-9 mt-5 ms-4 md:mt-3 me-4 md:me-6">
            <div className="flex flex-row items-center justify-between">
              <div className="flex flex-row items-center">
                <div className="text-lg md:text-2xl me-3">ประเภททั้งหมด</div>
              </div>
              <button
            ...
            <div>
              <DatatableType   onEdit={toggleModalEdit}/>
              {/* <DatatableProject /> */}
            </div>
          </div>
        </div>
